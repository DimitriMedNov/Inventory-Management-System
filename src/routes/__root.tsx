...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Sistema de Inventario de Taller" },
      { name: "description", content: "Plataforma web empresarial para control de inventario, solicitudes y movimientos de almacén." },
    ],
